...
#include "htmvsnonmodel.h"

const int ledPin1 = 22;
const int ledPin2 = 23;
const int ledPin3 = 24;

const float accelerationThreshold = 1.7; // 
...
const char* GESTURE[] = {
  "Eating gesture", "Non-eating gesture"
};
      ...
      if (samplesRead == numSamples) {
       ...
       for (int i = 0; i < NUM_GESTURE; i++) {
        ...
        if(GESTURE[i]==GESTURE[1] && tflOutputTensor->data.f[i]<0.5)
        {
          ...
          Serial.print("Detected gesture: Eating gesture. Accuracy: "  );
        ...
        else if(GESTURE[i]==GESTURE[1] && tflOutputTensor->data.f[i]>0.5)
        {
          ...
          delay(1000);              // wait for a second
          Serial.print("Detected gesture: non-eating gesture. Accuracy: " );

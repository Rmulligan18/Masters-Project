...
//works 10 chew vs 10 head movement
//#include "chewvsheadmovementmodel.h"
//example
//#include "egmodel.h"
//20 chew vs 10 head movement**
//#include "chew20model.h"
    ...
    if (IMU.accelerationAvailable() && IMU.gyroscopeAvailable()) {
      ...
      if (samplesRead == numSamples) {
        ...
        else if(GESTURE[i]==GESTURE[1] && tflOutputTensor->data.f[i]>0.5)
        {
          ...
          delay(1000);              // wait for a second
          Serial.print("head movement detected");
